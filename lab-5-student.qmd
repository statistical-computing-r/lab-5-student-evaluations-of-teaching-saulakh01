...
> The dataset of instructors records various types of variables about the instructors and their demographics. Gender, seniority, number of degrees, types of degrees are part of their demographic data. The dataset also contains information about their performances as instructors through feedback from their students. THis feedback is in the form of a survery, as well as the statistical information of student performance.

```{r}
#| label: explore-data
# exploring our teacher dataset
summary(evals)
dim(evals)
```
